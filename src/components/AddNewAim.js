...
const AddNewAim = () => {
    return (
        <BlackCards>
            ...
            <center><img src="https://res.cloudinary.com/dn1jeryp3/image/upload/v1647918165/proyecto-final/emojione-monotone_sports-medal_xw813v.svg" alt="" />



                <Link to={"/plusaimtype"}> <CustomButtonCards>
                    Añadir un objetivo
                </CustomButtonCards>
                </Link>
                <br />
