...
const Aim = () => {
    return (
        <BlackCards>
            <CustomLink to={"/welcome"}><ImgPlusAimType src="https://res.cloudinary.com/dn1jeryp3/image/upload/v1647530651/proyecto-final/ep_arrow-left_zxewky.svg" alt="" className="back" /></CustomLink>
            <AimContainer>
            ...
            <center>
                <CustomLink to={"/debts"}> <AimType className="AimType">
                    <ImgPlusAimType src="https://res.cloudinary.com/dn1jeryp3/image/upload/v1647529371/proyecto-final/money1_ioqscu.svg" alt="" height={38} width={60} />
                    <H3>Salir de una deuda</H3>
                </AimType></CustomLink>
                <CustomLink to={"/savemoney"}> <AimType>
                    <ImgPlusAimType src="https://res.cloudinary.com/dn1jeryp3/image/upload/v1647529371/proyecto-final/Pig_kpecmp.svg" alt="" height={49.45} width={60} />
